...
import { upsertEducationLevel } from "@/lib/data/curriculum";
...
export function EducationLevelForm({ editing }: { editing?: Editing }) {
    ...
    >
      ...
      <div className="flex flex-wrap gap-3">
        <div className="flex flex-col gap-1">
          <Label htmlFor="name">Nombre del nivel educativo</Label>
          <Input
            id="name"
            name="name"
      ...
      <Button type="submit" disabled={pending} className="w-fit">
        {editing ? "Guardar cambios" : "Agregar nivel educativo"}
      </Button>
    </form>
  );
}
