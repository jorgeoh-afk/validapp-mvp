// Ver lengua-nm1-blueprint.test.ts. Lengua NM2: 35 preguntas, único eje.
// Soporta 1 ensayo completo de 25 sin repetir (10 de reserva).
...
const bankPath = path.resolve(
  __dirname,
  "ds-257-2009/segundo-nivel-medio/lengua-castellana-y-comunicacion/question-bank.json"
);
...
describe("blueprint real Lengua Castellana y Comunicación · Segundo Nivel Medio · D.S. 257/2009", () => {
  it("documenta cuántos ensayos de 25 preguntas soporta el banco actual sin repetir", () => {
    ...
    console.log(
      `[lengua-nm2] Banco: ${candidates.length} preguntas. Soporta ${supportedEssays} ensayo(s) completo(s) (objetivo ideal: ${Math.ceil(3 * TOTAL_QUESTIONS * 1.3)}).`
    );
